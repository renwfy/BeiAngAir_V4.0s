        ...
        if (mAirInfo != null) {
            ...
            if (mAirInfo.getOnoff() == AirConstant.UNABLE) {
                ...
                if (Device.DT_JY500 == mDevice.devType) {
                    iv_speed.setImageResource(R.drawable.ic_speed_f5_off);
                } else {
                    iv_speed.setImageResource(R.drawable.ic_speed_f3_off);
                }
                ...
                switch (speed) {
                    case AirConstant.WIND.LOW:
                        if (Device.DT_JY500 == mDevice.devType) {
                            iv_speed.setImageResource(R.drawable.ic_speed_f5_1_on);
                        } else if (Device.DT_X3 == mDevice.devType) {
                            iv_speed.setImageResource(R.drawable.ic_speed_f4_1_on);
                        } else {
                            iv_speed.setImageResource(R.drawable.ic_speed_f3_1_on);
                        }
                        break;
                    case AirConstant.WIND.MID:
                        if (Device.DT_JY500 == mDevice.devType) {
                            iv_speed.setImageResource(R.drawable.ic_speed_f5_2_on);
                        } else if (Device.DT_X3 == mDevice.devType) {
                            iv_speed.setImageResource(R.drawable.ic_speed_f4_2_on);
                        } else {
                            iv_speed.setImageResource(R.drawable.ic_speed_f3_2_on);
                        }
                        break;
                    case AirConstant.WIND.HIGH:
                        if (Device.DT_JY500 == mDevice.devType) {
                            iv_speed.setImageResource(R.drawable.ic_speed_f5_3_on);
                        } else if (Device.DT_X3 == mDevice.devType) {
                            iv_speed.setImageResource(R.drawable.ic_speed_f4_3_on);
                        } else {
                            iv_speed.setImageResource(R.drawable.ic_speed_f3_3_on);
                        }
                        break;
                    case AirConstant.WIND.FOUR:
                        if (Device.DT_X3 == mDevice.devType) {
                            iv_speed.setImageResource(R.drawable.ic_speed_f4_4_on);
                        }else {
                            iv_speed.setImageResource(R.drawable.ic_speed_f5_4_on);
                        }
                        break;
                    case AirConstant.WIND.FIVE:
                        iv_speed.setImageResource(R.drawable.ic_speed_f5_5_on);
                        break;
                }
            ...
            case R.id.iv_speed:
                ...
                if (mAirInfo.getOnoff() == AirConstant.UNABLE) {
                    ...
                    if (Device.DT_JY500 == mDevice.devType) {
                        ...
                        if (speed < AirConstant.WIND.FOUR) {
                            speed++;
                        } else {
                            speed = AirConstant.WIND.LOW;
                        }
